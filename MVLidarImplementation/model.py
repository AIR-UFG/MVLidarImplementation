...
# %% auto 0
__all__ = ['Inception_2', 'InceptionBlock', 'Encoder', 'Decoder', 'MVLidar']
...
class Decoder(nn.Module):
    ...
    def deconvBlock1(self, x, block2):
      return self.relu(self.conv2(self.relu(self.conv1(self.concat_block2(self.deconv1(x), block2)))))

    def deconvBlock2(self, x, block1):
      return self.relu(self.conv4(self.relu(self.conv3(self.concat_block1(self.deconv2(x), block1)))))

    def deconvBlock3(self, x):
      return self.relu(self.conv6(self.relu(self.conv5(self.deconv3(x)))))
